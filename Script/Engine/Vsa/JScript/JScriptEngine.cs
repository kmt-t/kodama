...
namespace Kodama.Script.Engine.Vsa.JScript
{
    ...
    public class JScriptEngine : IScriptEngine
    {
        ...
        /// </summary>
        private class JScriptVsaSite : IVsaSite
        {
            /// <summary>
            /// デフォルトルートモニカ
            /// </summary>
            ...
            /// Vsaエンジン
            /// </summary>
            private IVsaEngine vsaEngine = new Microsoft.JScript.Vsa.VsaEngine();
...
//                    IVsaError[] cei = (IVsaError[])errors.ToArray(typeof(IVsaError));   // 何故か例外が発生するときがある
        ...
        /// IVsaSiteを実装する内部エンジン
        /// </summary>
        JScriptVsaSite site = new JScriptVsaSite();
